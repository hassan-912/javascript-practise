...
<footer className="bg-black dark:bg-primary">
  <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div
      className="flex flex-col items-center gap-4 rounded-lg bg-gradient-to-r from-red-900 via-red-700 to-orange-700 p-6 shadow-lg sm:flex-row sm:justify-between"
    >
      ...
      <ul className="flex justify-center gap-6 sm:justify-end">
        <li>
          <a
            ...
            rel="noreferrer"
            target="_blank"
            className="text-white transition hover:text-white dark:text-white dark:hover:text-primary2"
          >
